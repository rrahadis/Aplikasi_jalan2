...
public class Main7Activity extends AppCompatActivity implements View.OnClickListener {
    Button button;
    CheckBox pil1, pil2, pil3, pil4, pil5, pil6, pil7, pil8, pil10, pil11, pil12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pil7 = (CheckBox) findViewById(R.id.pil7);
        pil7.setOnClickListener(this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://wa.me/6285710844084?text=Saya%20ingin%20pesan%20ke%20papua"));
